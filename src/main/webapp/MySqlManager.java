...
public class MySqlManager {
	...
	///variables//////////
	////////////////////
    private String USERNAME,PASSWORD,DB_HOST,DB_PORT ,APP_NAME ,DB_CONN;
	...
	/**Index starts with 1*/
    public String selectWord(int index, LanguageTags languageTag){
    	return "SELECT `"+languageTag.tag+"` FROM `Languages` WHERE `index`="+index;
    }
    /**Index starts with 1*/
    public String selectWord(int index, String languageTag){
    	return "SELECT `"+languageTag+"` FROM `Languages` WHERE `index`="+index;
    }
